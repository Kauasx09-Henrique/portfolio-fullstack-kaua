...
const projects = [
  ...
  {
    title: 'MavaConnect+',
    description: 'Sistema para igrejas com gestão de visitantes, integração com WhatsApp, e dashboards administrativos.',
    site: 'https://mava-connect.vercel.app/',
    technologies: ['React', 'Node.js', 'Express', 'Tailwind CSS', 'PostgreSQL'],
    accentColor: '#5AC8FA'
  }
];
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
          {projects.map((project, index) => (
            <motion.div
              key={index}
              className="bg-[#1e0d3c] p-8 rounded-2xl shadow-xl border border-transparent hover:border-white-800 relative group"
              ...
              whileHover={{
                y: -10,
                boxShadow: `0 15px 40px ${project.accentColor}40`,
            ...
            >
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {project.technologies.map((tech, idx) => (
                  <motion.span
                    key={idx}
                    className="px-3 py-1 bg-[#2a1a4a] text-gray-200 rounded-full text-sm border border-transparent transition-all duration-200"
                    whileHover={{
              ...
              {project.site ? (
                <motion.a
                  ...
                  whileHover={{
                    scale: 1.05,
                    boxShadow: `0 8px 25px ${project.accentColor}70`
                  }}
                  whileTap={{ scale: 0.98 }}
                >
